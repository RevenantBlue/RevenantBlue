<?php
// Define the root of the current website and use the all inclusive DIRECTORY SEPARATOR constant.
...
function aclVerify($moduleName, $userId = FALSE) {
	$acl = new ACL;
	if(class_exists('site\Users')) {
		$users = new site\Users;
	} elseif(class_exists('admin\Users')) {
