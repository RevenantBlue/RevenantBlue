	...
	<div id="fixed-inner" class="clearfix">
		<div id="action-menu-wrap">
			...
			<ul id="action-menu">
				...
				<li>
					<a href="<?php echo HTTP_ADMIN; ?>articles" id="action-close-article">
			...
			<div id="toolbar" class="toolbar-list">
				<ul>
					...
					<li id="toolbar-cancel">
						<a href="<?php echo HTTP_ADMIN; ?>articles/">
							<span class="ui-icon ui-icon-close"></span>
		...
		<div id="element-box">
			<?php if(isset($_GET['id']) && isset($_GET['controller']) && $_GET['controller'] == 'article-revisions'): ?>
				...
				<div id="content-padding">
					<div class="element">
						...
						<div class="element-body">
							...
							<table id="article-revision-tbl" class="panel-content width100pcnt">
								<tr>
									<th class="width10pcnt">
										<p>Title</p>
									</th>
									<td class="width90pcnt">
										<p><?php echo hsc($revision['title']); ?></p>
									</td>
								</tr>
								<tr>
									<th class="vAlignTop">
							...
							<table id="revision-tbl" class="panel-content width100pcnt">
								<tr>
									...
									<td class="width90pcnt">
										<p><?php if(isset($newRevision['title'])) echo hsc($newRevision['title']); ?></p>
									</td>
								</tr>
								<tr>
									<th class="vAlignTop">
					...
					<table class="overview width100pcnt">
						...
						<?php foreach($articleRevisions as $num => $revision): ?>
						<tr class="overview-row1">
							...
							<td>
								<input type="radio" name="oldRevision" value="<?php echo hsc($revision['revision_id']); ?>"
									   ...
									   checked="checked"
									   <?php elseif(!isset($_GET['compare']) && $num === count($articleRevisions) - 1): ?>
									   checked="checked"
									   <?php endif; ?>
								/>
							</td>
							...
							<td class="left">
								<a href="<?php echo HTTP_ADMIN . "articles/revision/" . $revision['revision_id'] . "/" . $articleId; ?>">
					...
					<div class="panel">
						<div class="panel-column">
							<div class="element vert-space">
								...
								<div class="element-body">
									<ul id="granularity" class="std-list"s>
										<li class="block">
